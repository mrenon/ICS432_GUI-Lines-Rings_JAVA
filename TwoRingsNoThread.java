...
public class TwoRingsNoThread extends JPanel {
	 ...
	 * main
	 * 
	 * takes in two a command line arguments and sets it as P1 p2
	 * then creates a new TwoRingsNoThread
	 * 
	...
	/*
	 * creates an TwoRing GUI that creates a seperate threads to run both created ring panels
	 */
	public TwoRingsNoThread() {
